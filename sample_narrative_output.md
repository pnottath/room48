# No ANTHROPIC_API_KEY in environment — using DemoMockProvider
# Set ANTHROPIC_API_KEY to get genuine LLM output.

# Janma Kundali — A Room 48 Reading
...
## Yoga Phalam — Combinations & Their Results
...
## Current Dasa Phalam — Running Period
...
## Upcoming Dasa Phalam — Future Periods
...
7 sections generated by demo-mock.
  Prompt-cache hits   : 0/7
  Tokens in (uncached): 0
  Tokens in (cache rd): 0
  Tokens in (cache wr): 0
  Tokens out          : 0
